...
static DJIMotorInstance *friction_up, *friction_below, *loader; // 拨盘电机
...
void ShootInit()
{
    ...
    friction_below = DJIMotorInit(&friction_config);
...
void ShootTask()
{
    ...
    if (shoot_cmd_recv.shoot_mode == SHOOT_OFF)
    {
        ...
        DJIMotorStop(friction_below);
        DJIMotorStop(loader);
    }
    else // 恢复运行
    {
        DJIMotorEnable(friction_up);
        DJIMotorEnable(friction_below);
    ...
    case LOAD_1_BULLET:                                                                     // 激活能量机关/干扰对方用,英雄用.
        ...
        DJIMotorSetRef(loader,60000); // 控制量增加一发弹丸的角度
